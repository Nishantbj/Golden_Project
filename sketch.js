...
function setup() {
  ...
  star1 = new Obstacle(200, 250,starImg);
  star2 = new Obstacle(450, 150,starImg);
  star3 = new Obstacle(700, 250,starImg);
  star4 = new Obstacle(950, 150,starImg);
  star5 = new Obstacle(1150, 300,starImg);
  PLAY = 1;
  END = 0;
  gameState = PLAY;
  bgSound.loop();
